...
class SupplierHistory extends StatefulWidget {
  const SupplierHistory({Key? key}) : super(key: key);

  @override
  State<SupplierHistory> createState() => supplierHistory();
}

class supplierHistory extends State<SupplierHistory> {
  int selectedIndex = 1;
  ...
  Widget build(BuildContext context) {
    ...
    final List<HistoryCommonCard> SupplierHistoryList = [
      HistoryCommonCard(
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: SupplierHistoryList.length,
              itemBuilder: (context, index) {
                final card = SupplierHistoryList[index];
