...
class ChillingHistory extends StatefulWidget {
  const ChillingHistory({Key? key}) : super(key: key);

  @override
  State<ChillingHistory> createState() => chillingHistory();
}

class chillingHistory extends State<ChillingHistory> {
  int selectedIndex = 1;
  ...
  Widget build(BuildContext context) {
    ...
    final List<HistoryCommonCard> ChillingHistoryList = [
      HistoryCommonCard(
        title: 'Refrigerator',
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: ChillingHistoryList.length,
              itemBuilder: (context, index) {
                final card = ChillingHistoryList[index];
