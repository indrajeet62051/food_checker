    ...
    return Scaffold(
      appBar: AppBar(
        ...
        Container(alignment: Alignment.center,
          child: commonText(text: "Report", txtSize: 20,color: black,fontWeight: FontWeight.w600),),
        // backgroundColor: Colors.red,
      ),

      body: SingleChildScrollView(
        child: Padding(
          padding: const EdgeInsets.only(top: 20,right: 16,left: 16,bottom: 25),
          child: Column(children: [
            ...
            // ),////
            ReportCard(reportTitle: "Oven Not Heating Properly", reportDetail: "The oven is not reaching the required temperature,causing delays in food preparation. The issue wasreported after multiple failed attempts to heat itproperly.", taskText: "Maintain hygiene in food Preparation.", reporterName: "Sarah Thompson", userAvatarPath: 'assets/images/reporter2.png'),

            ReportCard(
                reportTitle: "Gas leak Detacted", reportDetail: "abcgsbsb", taskText: "vjhsdvh", userAvatarPath: 'assets/images/reporter1.png', reporterName: "nikhil"),
            ReportCard(
                reportTitle: "Gas leak Detacted", reportDetail: "abcgsbsb", taskText: "vjhsdvh", reporterName: "nikhil ",userAvatarPath: 'assets/images/reporter2.png')
